...
docker run -d -v bitcoin:/home/cointainer/.bitcoin/ -v ${SCRIPTPATH}/config:/home/cointainer/config/bitcoin -p 127.0.0.1:18332:18332  --name bitcoin-core-${NET} cointainer/bitcoin-core${PARAMS} $@
